...
export const products: Product[] = [
  ...
  {
    slug: "ats",
    name: "W2R Series Dual Power ATS",
    shortName: "W2R Series",
    category: "ATS",
    parentCategory: "ATS",
    series: "W2R Series",
    seriesAliases: ["W2R-63", "W2R-100", "W2R-125", "Dual Power ATS", "W2R-100 II"],
    application: "Automatic mains / generator source transfer",
    image: "/assets/products/gallery/ats-1.webp",
    summary: "Dual-power automatic transfer switch (PC class) for mains-to-generator changeover — 2P / 3P / 4P, 63A–125A, millisecond switching, DIN-rail mount.",
    description:
      "The TPKELE W2R series is a dual-power automatic transfer switch (PC utilization class, IEC/EN 60947-6-1) that switches critical loads between Source A (mains / city power) and Source B (generator / backup) automatically within milliseconds. Available in 2P / 3P / 4P and 63A / 100A / 125A ratings with manual/auto operation and mechanical interlock, it mounts on standard 35mm DIN rail and uses a flame-retardant PC housing — built for backup power in buildings, factories, telecom rooms and solar-grid hybrid systems.",
    specs: [
      "Dual-source automatic changeover (Source A mains → Source B generator)",
      "PC utilization class per IEC / EN 60947-6-1",
      "2P / 3P / 4P, 63A / 100A / 125A rated current",
      "Manual / Auto operation with mechanical interlock",
      "690V insulation, 8kV impulse withstand voltage",
      "Flame-retardant PC housing, 35mm DIN-rail mounting",
    ],
    seoKeywords: [
      "W2R ATS",
    ...
    technicalSpecs: [
      { label: "Product Model", value: "W2R-63 / W2R-100 / W2R-125 II" },
      { label: "Product Type", value: "Dual Power Automatic Transfer Switch (Dual Power ATS)" },
      { label: "Utilization Class", value: "PC (per IEC / EN 60947-6-1)" },
      { label: "Poles", value: "2P / 3P / 4P" },
      { label: "Rated Working Current", value: "63A / 100A / 125A (per model)" },
      { label: "Rated Working Voltage", value: "AC 230V / 400V (110V version available)" },
      { label: "Insulation Voltage", value: "AC 690V" },
      { label: "Impulse Withstand Voltage", value: "8 kV" },
      { label: "Rated Frequency", value: "50 / 60 Hz" },
      { label: "Source Configuration", value: "Source A (Mains / City Power) + Source B (Generator / Backup)" },
      { label: "Operation Mode", value: "Manual / Auto with mechanical interlock" },
      { label: "Switching Response", value: "Millisecond-level transfer" },
      { label: "Housing Material", value: "Flame-Retardant PC (UL94 V-0)" },
      { label: "Installation", value: "35mm Standard DIN Rail" },
      { label: "Standard", value: "IEC / EN 60947-6-1" },
      { label: "Certification", value: "CE, RoHS" },
    ],
    specMatrices: [
      {
        title: "Model Range",
        headers: ["Model", "Poles", "Rated Current", "Typical Application"],
        rows: [
          ["W2R-63", "2P / 3P / 4P", "63A", "Residential & small commercial backup"],
          ["W2R-100", "2P / 3P / 4P", "100A", "Commercial & light industrial feeds"],
          ["W2R-125", "2P / 3P / 4P", "125A", "Industrial main / sub-main distribution"],
        ],
        note: "All models share the same PC-class dual-power switching mechanism. Confirm pole count, rated current and rated voltage (AC 230V / 400V standard, 110V on request) when ordering.",
      },
    ],
  },
  {
...
export const categoryContent: Record<ProductCategory, CategoryContent> = {
  ...
  ATS: {
    ...
    intro:
      "TPKELE automatic transfer switches (ATS) move critical loads between Source A (mains) and Source B (generator / backup) automatically within milliseconds. The W2R dual-power series is a PC utilization class switch per IEC / EN 60947-6-1, available in 2P / 3P / 4P and 63A–125A ratings with manual/auto operation, mechanical interlock, 690V insulation and 8kV impulse withstand. DIN-rail mounted in a flame-retardant PC housing — built for industrial contractors, panel builders and project distributors who need reliable source transfer.",
    bullets: [
      "Automatic source transfer between mains and generator / backup",
      "PC utilization class per IEC / EN 60947-6-1",
      "2P / 3P / 4P, 63A–125A current ratings",
      "Manual / Auto operation with mechanical interlock",
      "690V insulation, 8kV impulse withstand voltage",
      "Flame-retardant PC housing, 35mm DIN-rail mount",
    ],
    ...
    faq: [
      { q: "What current ratings are available?", a: "The W2R dual-power ATS series covers 63A, 100A and 125A across 2P, 3P and 4P configurations. Contact us with your line current and we will confirm a model and breaking specification." },
      { q: "Can the ATS work with diesel generators?", a: "Yes — the W2R ATS is designed for mains (Source A) plus diesel generator (Source B) setups. It transfers loads automatically when the primary source fails and returns when mains is restored." },
      { q: "What utilization class is the W2R ATS?", a: "It is a PC utilization class switch per IEC / EN 60947-6-1 — it makes and withstands but does not break short-circuit currents, the standard class for backup-power source transfer. For zero-break operation, an upstream UPS is recommended." },
    ...
    seoTitle: "Dual Power ATS Manufacturer | W2R Automatic Transfer Switch 2P 3P 4P — TPKELE",
    seoDescription:
      "TPKELE W2R dual-power automatic transfer switch (ATS): PC class, 2P/3P/4P, 63A–125A, 690V insulation, 8kV impulse, IEC/EN 60947-6-1, CE & RoHS. For mains-to-generator backup power. OEM-ready.",
    seoKeywords: ["W2R ATS", "dual power automatic transfer switch", "ATS manufacturer", "automatic transfer switch", "ATS 4P", "generator transfer switch", "PC class ATS", "IEC 60947-6 ATS", "DIN rail ATS"],
  },
  "Combiner Box": {
...
const defaultTechnicalSpecsByCategory: Record<ProductCategory, Array<{ label: string; value: string }>> = {
  ...
  ATS: [
    { label: "Utilization Class", value: "PC (IEC / EN 60947-6-1)" },
    { label: "Poles", value: "2P / 3P / 4P" },
    { label: "Rated Current", value: "63A – 125A" },
    { label: "Rated Voltage", value: "230V / 400V AC" },
    { label: "Insulation Voltage", value: "690V AC" },
    { label: "Impulse Withstand Voltage", value: "8 kV" },
    { label: "Operation", value: "Manual / Auto, mechanical interlock" },
    { label: "Mounting", value: "DIN-rail 35mm" },
    { label: "Certification", value: "CE, RoHS, IEC 60947-6-1" },
  ],
  "Combiner Box": [
