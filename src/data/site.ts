...
export const products: Product[] = [
  ...
  {
    slug: "ats-st",
    name: "ATS-ST Series Dual Power Automatic Transfer Switch",
    shortName: "ATS-ST Series",
    category: "ATS",
    parentCategory: "ATS",
    series: "ATS-ST Series",
    seriesAliases: ["ATS-ST", "ATS-ST-2P", "ATS-ST-4P", "ST Series ATS"],
    application: "Fast dual-source changeover for backup power",
    image: "/assets/products/gallery/ats-st-1.webp",
    summary: "PC-class dual-power automatic transfer switch — 2P / 4P, 63A, millisecond (≤0.05s) changeover between mains and backup, flame-retardant housing.",
    description:
      "The TPKELE ATS-ST series is a PC-class (load-level) dual-power automatic transfer switch that moves critical loads between two sources within ~50ms. With 2 inputs / 1 output, auto and manual operation and a flame-retardant PA6 housing, it is built for fast, reliable changeover between mains and a generator, inverter or backup feed. Available in 2P (single-phase) and 4P (three-phase + neutral) configurations rated 63A.",
    specs: [
      "PC class (load level) — fast changeover ≤0.05s (50ms)",
      "2P (single-phase) and 4P (three-phase + neutral)",
      "63A rated current, operating range 6A–63A",
      "110V / 220V AC, 50/60Hz",
      "Auto & Manual operation, 2 inputs / 1 output",
      "PA6 flame-retardant housing",
    ],
    seoKeywords: [
      "ATS-ST",
      "dual power automatic transfer switch",
      "PC class ATS",
      "2P 4P transfer switch",
      "ATS manufacturer",
      "generator transfer switch",
      "automatic transfer switch 63A",
    ],
    gallery: [
      "/assets/products/gallery/ats-st-1.webp",
      "/assets/products/gallery/ats-st-2.webp",
      "/assets/products/gallery/ats-st-3.webp",
      "/assets/products/gallery/ats-st-4.webp",
    ],
    technicalSpecs: [
      { label: "Product Model", value: "ATS-ST (2P / 4P)" },
      { label: "Product Type", value: "Dual Power Automatic Transfer Switch" },
      { label: "Utilization Class", value: "PC Class (Load Level)" },
      { label: "Poles", value: "2P (Live + Neutral) / 4P (3 Lines + Neutral)" },
    ...
    specMatrices: [
      {
        title: "Pole Configurations",
        headers: ["Model", "Poles", "Phase", "Over/Under-Voltage Protection", "Typical Application"],
        rows: [
          ["ATS-ST-2P", "2P (Live + Neutral)", "Single Phase", "Optional", "Home emergency backup, RV"],
          ["ATS-ST-4P", "4P (3 Lines + Neutral)", "Three-Phase + Neutral", "145V/260V & 85V/175V", "Hospitals, cold storage, data centers"],
        ],
        note: "All ATS-ST variants are PC class with ~50ms transfer time and 63A rating. Confirm pole count and rated voltage (110V or 220V) when ordering.",
      },
    ],
  },
  {
    slug: "ats-w2r",
    name: "ATS-W2R Series Dual Power Automatic Transfer Switch",
    shortName: "ATS-W2R Series",
    category: "ATS",
    parentCategory: "ATS",
    series: "ATS-W2R Series",
    seriesAliases: ["ATS-W2R", "W2R", "W2R-100 II", "W2R-2P", "W2R-3P", "W2R-4P"],
    application: "Mains / generator changeover with voltage protection",
    image: "/assets/products/gallery/ats-w2r-1.webp",
    summary: "PC-class W2R dual-power automatic transfer switch — 2P / 3P / 4P, 63A, ≤0.05s changeover with built-in over/under-voltage protection.",
    description:
      "The TPKELE ATS-W2R series (W2R-100 II) is a PC-class dual-power automatic transfer switch that switches loads between Source A (mains / city power) and Source B (generator / backup) within ~50ms. It adds built-in over-voltage and under-voltage protection on top of fast changeover, with auto/manual operation and a flame-retardant PA6 housing. Available in 2P, 3P and 4P configurations rated 63A at 110V / 220V AC.",
    specs: [
      "PC class — fast changeover ≤0.05s (50ms)",
      "2P / 3P / 4P, 63A (operating range 6A–63A)",
      ...
      "PA6 flame-retardant housing, DIN-rail mount",
    ],
    seoKeywords: [
      "ATS-W2R",
      "W2R-100 II",
      ...
      "PC class ATS",
      "2P 3P 4P ATS",
      "ATS with voltage protection",
      "generator transfer switch",
      "ATS manufacturer",
    ],
    gallery: [
      "/assets/products/gallery/ats-w2r-1.webp",
      "/assets/products/gallery/ats-w2r-2.webp",
      "/assets/products/gallery/ats-w2r-3.webp",
      "/assets/products/gallery/ats-w2r-4.webp",
    ],
    technicalSpecs: [
      { label: "Product Model", value: "ATS-W2R (W2R-100 II)" },
      { label: "Product Type", value: "Dual Power Automatic Transfer Switch" },
      { label: "Utilization Class", value: "PC Class (Load Level)" },
    ...
    specMatrices: [
      {
        title: "Pole Configurations",
        headers: ["Model", "Poles", "Phase", "Typical Application"],
        rows: [
          ["ATS-W2R-2P", "2P (Live + Neutral)", "Single Phase", "Home & small commercial backup"],
          ["ATS-W2R-3P", "3P (3 Lines, No Neutral)", "Three-Phase (No Neutral)", "Three-phase motor & equipment feeds"],
          ["ATS-W2R-4P", "4P (3 Lines + Neutral)", "Three-Phase + Neutral", "Hospitals, cold storage, data centers"],
        ],
        note: "All ATS-W2R variants are PC class, 63A, ~50ms transfer with built-in over/under-voltage protection. Confirm pole count and rated voltage (110V or 220V) when ordering.",
      },
    ],
  },
  {
    slug: "stq1",
    name: "STQ1 Series CB-Class Automatic Transfer Switch",
    shortName: "STQ1 Series",
    category: "ATS",
    parentCategory: "ATS",
    series: "STQ1 Series",
    seriesAliases: ["STQ1", "STQ1-63", "STQ1-2P", "STQ1-3P", "STQ1-4P"],
    application: "Motorized CB-class source transfer for critical loads",
    image: "/assets/products/gallery/stq1-1.webp",
    summary: "CB-class motorized automatic transfer switch with mechanical interlock — 2P / 3P / 4P, 63A, ~2s transfer for fire, elevator and industrial backup.",
    description:
      "The TPKELE STQ1 series is a CB-class (circuit breaker + mechanical interlock) automatic transfer switch driven by a built-in motor. It transfers loads between the normal (mains) supply and a backup source in about 2 seconds, with mechanical interlock preventing both sources connecting at once. Available in 2P / 3P / 4P at 63A, it suits home emergency, fire-protection, elevator and three-phase industrial backup where a robust, interlocked changeover is required.",
    specs: [
      "CB class — circuit breaker + mechanical interlock",
      "Motorized auto transfer, ~2s changeover",
      "2P / 3P / 4P, 63A (operating range 6A–63A)",
      "Mechanical interlock prevents dual-source connection",
      "110V / 220V AC, 50/60Hz, Auto & Manual",
    ...
    seoKeywords: [
      "STQ1",
      "CB class ATS",
      "motorized automatic transfer switch",
      "mechanical interlock ATS",
      "2P 3P 4P transfer switch",
      "fire protection transfer switch",
      "elevator backup ATS",
      "ATS manufacturer",
    ],
    gallery: [
      "/assets/products/gallery/stq1-1.webp",
      "/assets/products/gallery/stq1-2.webp",
      "/assets/products/gallery/stq1-3.webp",
      "/assets/products/gallery/stq1-4.webp",
    ],
    technicalSpecs: [
      { label: "Product Model", value: "STQ1-63" },
      ...
      { label: "Max Load Power", value: "~6.9kW (1P) / ~22kW (3-phase)" },
    ...
    specMatrices: [
      {
        title: "Pole Configurations",
        headers: ["Model", "Poles", "Max Load Power", "Typical Application"],
        rows: [
          ["STQ1-63-2P", "2P (Live + Neutral)", "~6.9kW (6930W)", "Home emergency, fire protection, RV"],
          ["STQ1-63-3P", "3P (Simultaneous)", "~22kW (Three-Phase)", "Industrial equipment, commercial elevators, 3-phase motors"],
          ["STQ1-63-4P", "4P (3 Lines + Neutral)", "~13.9kW (13870W)", "Hospitals, cold storage, data centers"],
        ],
        note: "All STQ1 variants are CB class with mechanical interlock and ~2s motorized transfer. A brief power interruption (~2s) occurs during changeover. Confirm pole count and rated voltage when ordering.",
      },
    ],
  },
  {
    slug: "stq2",
    name: "STQ2 Series CB-Class Automatic Transfer Switch",
    shortName: "STQ2 Series",
    category: "ATS",
    parentCategory: "ATS",
    series: "STQ2 Series",
    seriesAliases: ["STQ2", "STQ2-63", "STQ2-2P", "STQ2-3P", "STQ2-4P"],
    application: "Heavy-duty CB-class source transfer with rotary handle",
    image: "/assets/products/gallery/stq2-1.webp",
    summary: "Heavy-duty CB-class automatic transfer switch with rotary handle and mechanical interlock — 2P / 3P / 4P, 63A, ~2s transfer for industrial and critical backup.",
    description:
      "The TPKELE STQ2 series is a heavy-duty CB-class (circuit breaker + mechanical interlock) automatic transfer switch with a rotary handle for clear position indication and manual override. A built-in motor transfers loads between normal (mains) and emergency sources in about 2 seconds, with mechanical interlock ensuring only one source connects at a time. Offered in 2P / 3P / 4P at 63A, it is built for industrial equipment, hospitals, cold storage and data-center backup where a rugged, panel-mount changeover is preferred.",
    specs: [
      "CB class — circuit breaker + mechanical interlock",
    ...
    seoKeywords: [
      ...
      "mechanical interlock ATS",
      "2P 3P 4P transfer switch",
      "industrial transfer switch",
      "ATS manufacturer",
    ],
    gallery: [
      "/assets/products/gallery/stq2-1.webp",
      "/assets/products/gallery/stq2-2.webp",
      "/assets/products/gallery/stq2-3.webp",
      "/assets/products/gallery/stq2-4.webp",
    ],
    technicalSpecs: [
      { label: "Product Model", value: "STQ2-63" },
    ...
    specMatrices: [
      {
        ...
        headers: ["Model", "Poles", "Max Load Power", "Typical Application"],
        rows: [
          ["STQ2-63-2P", "2P (Live + Neutral)", "~6.9kW (6930W)", "Home emergency, fire protection, RV"],
          ["STQ2-63-3P", "3P (Simultaneous)", "~22kW (Three-Phase)", "Industrial equipment, commercial elevators, 3-phase motors"],
          ["STQ2-63-4P", "4P (3 Lines + Neutral)", "~13.9kW (13870W)", "Hospitals, cold storage, data centers"],
        ],
        note: "All STQ2 variants are CB class with mechanical interlock and ~2s motorized transfer. The rotary handle gives clear source-position indication and manual override. Confirm pole count and rated voltage when ordering.",
      },
    ],
  },
  {
...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    relatedProducts: ["ats-st", "ats-w2r", "stq1", "stq2"],
  },
  {
