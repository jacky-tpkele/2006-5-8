...
const dcIsolatorSelectionGuide: Guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `
        <p>A complete buying decision usually includes more than a single DC Isolator. Users often compare related products that work in the same project package so that protection, switching and monitoring decisions remain coordinated.</p>
        ...
        <figure class="guide-figure">
          <img src="/images/guides/dc-isolator-selection-guide/related-grid.png" alt="Related TPKELE product paths for DC Isolator" />
          <figcaption>Figure 3. Related TPKELE product paths for DC Isolator</figcaption>
        </figure>
      `,
    },
    {
      ...
      title: "Conclusion",
      content: `
        <p>A reliable DC Isolator decision combines product knowledge, application matching and documentation readiness. If you define the use case clearly and review the key parameters in a structured order, selection becomes faster and more accurate.</p>
