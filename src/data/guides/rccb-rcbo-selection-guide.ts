...
const rccbRcboSelectionGuide: Guide = {
  slug: "rccb-rcbo-selection-guide",
  title: "RCCB and RCBO Selection Guide for Leakage Protection",
  description: "Know when to select RCCB or RCBO and how to match residual current protection to the circuit.",
  product: "RCCB / RCBO",
  ...
  sections: [
    {
      ...
      content: `
        <p>Selecting the right RCCB / RCBO is critical for safety, reliability and commercial success. In real projects, a product decision should reflect the electrical system, the installation conditions and the buyer's documentation expectations, not just a basic catalogue line. This guide is written to help procurement teams, engineers and distributors move from a general product name to a usable specification path.</p>
        <p>The correct RCCB / RCBO selection process starts by understanding the actual application context. For TPKELE customers, this usually means matching product performance to solar PV, building electrical distribution or power-switching conditions, and then connecting the technical decision to quotation, export and project-delivery needs.</p>
        <div class="callout">Do not select a RCCB / RCBO only by one headline parameter. Review system voltage, current, switching duty, coordination and application context together.</div>
      `,
    },
    {
      id: "what-is-it",
      title: "What is a RCCB / RCBO?",
      content: `
        <p>A RCCB / RCBO is a low-voltage electrical product used to perform a defined protective, switching, control or monitoring function inside the system. Its real value is not the device alone, but how accurately it matches the circuit, the environment and the maintenance expectations of the user.</p>
        ...
        <figure class="guide-figure">
          <img src="/images/guides/rccb-rcbo-selection-guide/figure.png" alt="Functional selection view for RCCB / RCBO" />
          <figcaption>Figure 1. Functional selection view for RCCB / RCBO</figcaption>
        </figure>
      `,
    },
    {
      ...
      content: `
        <p>Before comparing suppliers, buyers should list the parameters that truly determine whether the RCCB / RCBO fits the project. Good product selection normally combines electrical ratings, application logic, physical arrangement and commercial documentation needs. That approach is more reliable than selecting by a model number alone.</p>
    ...
    },
    {
      ...
      content: `
        <p>A practical selection workflow for RCCB / RCBO starts with the electrical system and not the catalogue. Confirm the system voltage, current or load duty, application type, pole or functional arrangement, installation conditions and coordination requirements. Only after that should model comparison begin.</p>
        ...
        <figure class="guide-figure">
          <img src="/images/guides/rccb-rcbo-selection-guide/quick-flow.png" alt="Quick selection workflow for RCCB / RCBO" />
          <figcaption>Figure 2. Quick selection workflow for RCCB / RCBO</figcaption>
        </figure>
      `,
    },
    {
    ...
    },
    {
      ...
      content: `
        <div class="faq-section">
          <div class="faq-item">
            <h4>What is the first parameter to confirm?</h4>
    ...
    },
    {
      ...
      content: `
        <p>A complete buying decision usually includes more than a single RCCB / RCBO. Users often compare related products that work in the same project package so that protection, switching and monitoring decisions remain coordinated.</p>
        ...
        <figure class="guide-figure">
          <img src="/images/guides/rccb-rcbo-selection-guide/related-grid.png" alt="Related TPKELE product paths for RCCB / RCBO" />
          <figcaption>Figure 3. Related TPKELE product paths for RCCB / RCBO</figcaption>
        </figure>
      `,
    },
    {
      ...
      title: "Conclusion",
      content: `
        <p>A reliable RCCB / RCBO decision combines product knowledge, application matching and documentation readiness. If you define the use case clearly and review the key parameters in a structured order, selection becomes faster and more accurate.</p>
