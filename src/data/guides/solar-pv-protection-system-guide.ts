...
const solarPvProtectionSystemGuide: Guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `
        <p>A complete electrical protection system typically includes more than a single PV Protection System. Projects often combine these devices with related products such as circuit breakers, surge protection devices, and monitoring equipment to create a coordinated protection system.</p>
