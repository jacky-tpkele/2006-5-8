...
const acMcbGuide: Guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `
        <p>A practical selection workflow for AC MCB starts with the electrical system and not the catalogue. Confirm the system voltage, current or load duty, application type, pole or functional arrangement, installation conditions and coordination requirements. Only after that should model comparison begin.</p>
    ...
    },
    {
      ...
      content: `
        <p>A complete buying decision usually includes more than a single AC MCB. Users often compare related products that work in the same project package so that protection, switching and monitoring decisions remain coordinated.</p>
        ...
        <figure class="guide-figure">
          <img src="/images/guides/ac-mcb-selection-guide/related-grid.png" alt="Related TPKELE product paths for AC MCB" />
          <figcaption>Figure 3. Related TPKELE product paths for AC MCB</figcaption>
        </figure>
      `,
    },
    {
      ...
      title: "Conclusion",
      content: `
        <p>A reliable AC MCB decision combines product knowledge, application matching and documentation readiness. If you define the use case clearly and review the key parameters in a structured order, selection becomes faster and more accurate.</p>
