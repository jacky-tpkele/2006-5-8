...
const voltageProtectorSelectionGuide: Guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `
        <p>A complete buying decision usually includes more than a single Voltage Protector. Users often compare related products that work in the same project package so that protection, switching and monitoring decisions remain coordinated.</p>
        ...
        <figure class="guide-figure">
          <img src="/images/guides/voltage-protector-selection-guide/related-grid.png" alt="Related TPKELE product paths for Voltage Protector" />
          <figcaption>Figure 3. Related TPKELE product paths for Voltage Protector</figcaption>
        </figure>
      `,
    },
    {
      ...
      title: "Conclusion",
      content: `
        <p>A reliable Voltage Protector decision combines product knowledge, application matching and documentation readiness. If you define the use case clearly and review the key parameters in a structured order, selection becomes faster and more accurate.</p>
