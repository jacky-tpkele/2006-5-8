...
export default function RelatedResources(){
  return <section className="contentSection pale"><div className="container">
    ...
    <div className="toolGrid">
      ...
      <Tool type="What Market Requires" title="Market Access Advisor" href="/electrical-international-standards-inquiry-center">Country-specific conformity, certification pathways and evidence status.</Tool>
