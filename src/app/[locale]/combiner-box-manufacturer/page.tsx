...
import { combinerBoxManufacturer as data } from "../_manufacturer/data-combiner-box";
...
export default async function CombinerBoxManufacturerRoute({ params }: PageProps) {
  const { locale } = await params;
